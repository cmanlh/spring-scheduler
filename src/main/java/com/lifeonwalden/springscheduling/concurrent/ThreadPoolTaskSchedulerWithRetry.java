...
public class ThreadPoolTaskSchedulerWithRetry extends ExecutorConfigurationSupport
  ...
  private static final long serialVersionUID = -2486398414197477561L;
   ...
   * <p>
   * Default is {@code false}. If set to {@code true}, the target executor will be switched into remove-on-cancel mode
   * (if possible, with a soft fallback otherwise).
   * <p>
   * <b>This setting can be modified at runtime, for example through JMX.</b>
   */
  @UsesJava7
   ...
   * <p>
   * The default implementation creates a {@link ScheduledThreadPoolExecutor}. Can be overridden in subclasses to
   * provide custom {@link ScheduledExecutorService} instances.
   * 
   ...
   * 
   * @return the underlying ScheduledExecutorService (never {@code null})
   * @throws IllegalStateException if the ThreadPoolTaskScheduler hasn't been initialized yet or if the underlying
   *         ScheduledExecutorService isn't a ScheduledThreadPoolExecutor
