...
public class CronBuilder {
  ...
  public String toCronExpression() {
    ...
    sb.append(second.toExpression()).append(" ").append(minute.toExpression()).append(" ").append(hour.toExpression())
        .append(" ").append(day.toExpression()).append(" ").append(month.toExpression()).append(" ")
        .append(weekday.toExpression());
